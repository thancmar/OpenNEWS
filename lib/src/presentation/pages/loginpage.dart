...
// import 'package:sharemagazines_flutter/src/blocs/auth/auth_bloc.dart' as auth;
...
//             print("AuthState $state");
//             Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => MainPage()), (Route<dynamic> route) => false); //removes everything below MainPage()
//           } else if (state is auth.IncompleteAuthenticated) {
...
//                                     // }),
//                                     // onPressed: () => Navigator.of(context).pop(true),
//                                     // onPressed: () => BlocProvider.of<auth.AuthBloc>(context).add(event),
//                                   ),
//                                   Text(
//                                     "Anmelden",
//                                     textAlign: TextAlign.left,
