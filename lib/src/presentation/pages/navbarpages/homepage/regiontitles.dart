...
class News_aus_deiner_RegionState extends State<News_aus_deiner_Region>
  ...
  static late ValueNotifier<int> titleIndex=ValueNotifier(0);
      ...
      children: [
        ...
        SizedBox(
          ...
          child: PageView.builder(
            ...
            onPageChanged: (int index) =>  titleIndex.value = index,
            itemBuilder: (_, i) {
                                ...
                                child: MarqueeWidget(
                                  ...
                                  child: MarqueeWidget(
                                    ...
                                    child: Text(
                                      ...
                                      textAlign: TextAlign.center,
                                      style:
                                          Theme.of(context).textTheme.bodyMedium!.copyWith(height: 0.8, color: Colors.grey, fontWeight: FontWeight.w300),
                                    ),
                                  ),
                                ),
                              ),
