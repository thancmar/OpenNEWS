                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      if (NavbarState.locationheader != null)
                        LocationOffersWidget(),
                      if (NavbarState.magazinePublishedGetTopLastByRange !=
                              null &&
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                News_aus_deiner_Region(
                                    index1: _index1, state: state),
                                // Positioned(
                                //   bottom: -70,
                    ...
                    itemBuilder: (_, i) {
                      return Card(
                        margin: EdgeInsets.fromLTRB(
                            i == 0 ? 20 : 5,
                            0,
                            i == snapshot.data!.locationOffer!.length - 1
                                ? 20
                                : 5,
                            0),
                        ...
                        child: FloatingActionButton.extended(
                          ...
                          label: Text(
                            snapshot
                                .data!.locationOffer![i].shm2Offer![0].title!,
                            // 'Speisekarte',
                            style: TextStyle(
                                fontSize: 12,
                                color: Colors.white,
