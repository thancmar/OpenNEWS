...
import 'homepage/tokenTimer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<NavbarBloc, NavbarState>(builder: (context, state) {
        ...
        }print("ebooks counter ${state.appbarlocation.hasEbooksAudiobooks}");
                                                  ...
                                                  children: [
                                                    ...
                                                    FutureBuilder<Uint8List>(
                                                            ...
                                                            builder: (context, snapshot) {
                                                              print("loacation image has data ${snapshot.hasData}");
                                                          ...
                                                          if (!counterValue)
                                                            {
                                                              Navigator.of(context).push(
                                                                CupertinoPageRoute(
                                                                  ...
                                                                  builder: (context) => SearchPage(hasEbooksAudiobooks: state.appbarlocation.hasEbooksAudiobooks=='1'?true:false,),
                                                                ),
                                                              )
                                                            }
                                                          else
                                                  ...
                                                  children: [
                                                    for (int a = 0; a < _masForUsing.length; a++)
                                                      Padding(
                                                        ...
                                                        child: Text(
                                                          _masForUsing[a],
                                                          style: a == 0? Theme.of(context).textTheme.bodyLarge!.copyWith(
                                                              // fontSize: a == 0 ? size.aspectRatio * 50 : size.aspectRatio * 40,
                                                              // fontWeight: a == 0 ? FontWeight.w500 : FontWeight.w300,
                                                              color: Colors.white): Theme.of(context).textTheme.bodyMedium!.copyWith(
                                                            // fontSize: a == 0 ? size.aspectRatio * 50 : size.aspectRatio * 40,
                                                            // fontWeight: a == 0 ? FontWeight.w500 : FontWeight.w300,
                                                              color: Colors.white),
                      ...
                      ClipPath(
                        ...
                        child: Stack(
                          children: [
                            ...
                            if ((currentIndex == 0 || currentIndex == 1) && state.appbarlocation.hasEbooksAudiobooks == '1')
                              Padding(
                                          ...
                                          child: BackdropFilter(
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                children: [
                                                  Expanded(
                                                    flex:  value == CategoryStatus.presse ?2:1,
                                                    child: InkWell(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Align(
                                                            ...
                                                            child: Text(
                                                              "Presse",
                                                              style:value == CategoryStatus.presse ?Theme.of(context)
                                                                  .textTheme
                                                  ...
                                                  Expanded(
                                                    flex:  value == CategoryStatus.ebooks ?2:1,
                                                    child: InkWell(
                                                      splashColor: Colors.transparent,
                                                      highlightColor: Colors.transparent,
                                                      onTap: () => {
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Align(
                                                            ...
                                                            child: Text(
                                                              "Ebooks",
                                                              style:value == CategoryStatus.ebooks ?Theme.of(context)
                                                                  .textTheme
                                                                  .titleLarge:Theme.of(context)
                                                                  .textTheme
                                                                  .titleSmall!
                                                  ...
                                                  Expanded(
                                                    flex:  value == CategoryStatus.hoerbuecher ?2:1,
                                                    child: InkWell(
                                                      splashColor: Colors.transparent,
                                                      highlightColor: Colors.transparent,
                                                      onTap: () => {
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Align(
                                                            ...
                                                            child: Text(
                                                              "Hörbücher",
                                                              style:value == CategoryStatus.hoerbuecher ?Theme.of(context)
                                                                  .textTheme
                                                                  .titleLarge:Theme.of(context)
                                                                  .textTheme
                                                                  .titleSmall!
