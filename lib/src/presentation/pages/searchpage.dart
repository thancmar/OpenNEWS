...
class _SearchPageState extends State<SearchPage> with AutomaticKeepAliveClientMixin<SearchPage> {
  ...
  void initState() {
    // print(widget.id);
    BlocProvider.of<SearchBloc>(context).add(Initialize(context));
    // BlocProvider.of<SearchBloc>(context).add(
    //   OpenSearch(),
    // );

    counterALL = BlocProvider.of<NavbarBloc>(context).state.magazinePublishedGetLastWithLimit!.response!.length;
    super.initState();
              ...
              actions: [
                InkWell(
                  ...
                  child: Hero(
                    ...
                    child: Icon(
                      state is GoToSearchPage ? Icons.search : Icons.close_rounded,
                      color: Colors.white,
                      size: 40,
                    ),
                    // child: ImageIcon(
                                        ...
                                        child: Expanded(
                                          child: Container(
                                            child: Padding(
                                              ...
                                              child: Text(
                                                // 'hamburg',
                                                state.searchResults!.isNotEmpty ? state.searchResults![i] : "eee",
