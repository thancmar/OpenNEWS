...
class ReaderScrollPages extends StatefulWidget {
  ...
  ReaderScrollPages({Key? key, required this.isOnPageTurning, required this.bloc, required this.reader}) : super(key: key);

  @override
  State<ReaderScrollPages> createState() => _ReaderScrollPagesState();
}

class _ReaderScrollPagesState extends State<ReaderScrollPages>
    with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin<ReaderScrollPages> {
