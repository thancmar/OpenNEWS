...
class ReaderOptionsPages extends StatefulWidget {
  ...
  ReaderOptionsPages({Key? key, required this.isOnPageTurning, required this.bloc, required this.reader, required this.currentPage})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return OrientationBuilder(builder: (context, orientation) {
      ...
      controller = PageController(
          ...
          initialPage: widget.reader.currentPage.value.round() - 1);
                                ...
                                return Stack(
                                  children: [
                                    Align(
                                      ...
                                      child: Container(
                                        padding: i == widget.reader.pageController.page ? EdgeInsets.fromLTRB(10, 10, 10, 10) : EdgeInsets.fromLTRB(5, 0, 5, 0),
