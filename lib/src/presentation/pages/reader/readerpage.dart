...
class _ReaderState extends State<Reader> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      //         pdfPinchController = CustumPdfControllerPinch(document: PdfDocument.openData(ReaderState.doc), viewportFraction: 0.5);
      //         //
      //       }
      //     },
      //     child: SizedBox(
      ...
      //         ),
      //         state is ReaderOpened?Container():Container()
      //         // CustumPdfViewPinch(
