...
//
//   _CustumPdfViewPinchState? _state;
...
//   }
//
//   /// Associate a [_CustumPdfViewPinchState] to the controller.
//   void _setViewerState(_CustumPdfViewPinchState? state) {
//     _state = state;
//     if (_state != null) {
//       notifyListeners();
//     }
//   }
//
//   void _attach(_CustumPdfViewPinchState pdfViewState) {
//     if (_state != null) {
//       return;
//     }
//
...
//   // }
//
//   /// Animates the controlled [CustumPdfViewPinch] to the next page.
//   ///
...
//
//   /// Animates the controlled [CustumPdfViewPinch] to the previous page.
//   ///
//   /// The animation lasts for the given duration and follows the given curve.
//   /// The returned [Future] resolves when the animation completes.
//   ///
...
//   /// If the controller is not ready([CustumPdfViewPinch]), the property
//   ///  throws an exception.
...
//   //       min(
//   //         rect.top - 500,
//   //         _state!._docSize!.height - _state!._lastViewSize!.height - 500,
//   //       ));
//   //   print("top = $top");
