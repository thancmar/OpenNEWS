...
class PlayerNavBarPainter extends CustomPainter {
  const PlayerNavBarPainter();
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double controlHeight = 50.0;
    // double centerPoint = (((1) / 4) * size.width) - ((1 / 4) * size.width) / 2;
...
class PlayerNavBarClipper extends CustomClipper<Path> {
  final int index;
  const PlayerNavBarClipper(this.index);

  @override
  getClip(Size size) {
    // print("Navbarclipper");
    final paint = Paint()
      ..color = Colors.green //Color(0x00ffffff)
      ..strokeWidth = 0.2
      ..style = PaintingStyle.stroke;
    double bendWidth = 35.0;
    double bezierWidth = 35.0;
