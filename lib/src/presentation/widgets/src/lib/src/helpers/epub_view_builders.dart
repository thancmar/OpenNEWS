...
typedef ChapterDividerBuilder = Widget Function(BuildContext context,EpubChapter value);
...
class DefaultBuilderOptions {
  ...
  // final EdgeInsetsGeometry paragraphPaddingvertical;
  ...
  const DefaultBuilderOptions({
    ...
    this.paragraphPadding = const EdgeInsets.symmetric(vertical: 0, horizontal: 16),
    // this.paragraphPaddingvertical = const EdgeInsets.symmetric(horizontal: 30),
