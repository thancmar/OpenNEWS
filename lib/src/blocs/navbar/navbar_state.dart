...
abstract class NavbarState extends Equatable {
  ...
  static MagazinePublishedGetAllLastByHotspotId?
      magazinePublishedGetLastWithLimit = null;
  static MagazinePublishedGetAllLastByHotspotId?
      magazinePublishedGetTopLastByRange = null;
  ...
  static late List<Future<Uint8List>>? languageResultsALL =
      List.empty(growable: true);
  static late List<Stream<Uint8List>>? languageResultsALLStream =
      List.empty(growable: true);
  static late List<Future<Uint8List>>? languageResultsDE =
      List.empty(growable: true);
  static late List<Future<Uint8List>>? languageResultsEN =
      List.empty(growable: true);
  static late List<Future<Uint8List>>? languageResultsFR =
      List.empty(growable: true);
  static late List<Future<Uint8List>>? getTopMagazines =
      List.empty(growable: true);
  ...
  static late List<Future<Uint8List>>? locationoffersImages =
      List.empty(growable: true);
