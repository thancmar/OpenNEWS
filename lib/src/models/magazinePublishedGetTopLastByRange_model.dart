// import 'dart:convert';
//
// magazinePublishedGetTopLastByRange MagazinePublishedGetLastWithLimitFromJson(String str) => magazinePublishedGetTopLastByRange.fromJson(json.decode(str));
//
// class magazinePublishedGetTopLastByRange {
//   List<Response>? response;
//
//   magazinePublishedGetTopLastByRange({required this.response});
//
//   magazinePublishedGetTopLastByRange.fromJson(Map<String, dynamic> json) {
